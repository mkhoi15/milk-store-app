...
import com.example.milk_store_app.Helper.Helpers;
import com.example.milk_store_app.constants.Appinfo;


public class ZalopayLibary { private class CreateOrderData {
    String AppId;
    String AppUser;
    String AppTime;
    String Amount;
